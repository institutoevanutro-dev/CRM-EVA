...
export const DICIONARIO: Traducoes = {
  ...
  // `activityLabel("lead_created", payload)` monta este rótulo por canal — a
  // chave abaixo é o outro valor possível (`payload.canal === "instagram"`).
  ...
  "Ver CPF": { es: "Ver CPF" },
  "consulta registrada": { es: "consulta registrada" },
  "cadastrado": { es: "registrado" },
  "Abrindo…": { es: "Abriendo…" },
  "Não foi possível ler o CPF desta ficha.": { es: "No fue posible leer el CPF de esta ficha." },
  ...
  // ─── Instagram Direct: cartão em Conexões e Inbox (Task 9) ───
  "via": { es: "vía" },
  "Conta do Instagram conectada.": { es: "Cuenta de Instagram conectada." },
  "Login do Instagram cancelado. Nada foi conectado.": { es: "Inicio de sesión de Instagram cancelado. No se conectó nada." },
  "O link de conexão venceu. Clique em Conectar Instagram de novo.": { es: "El enlace de conexión venció. Haz clic en Conectar Instagram otra vez." },
  "Esta conta do Instagram já está conectada em outra organização desta instalação.": { es: "Esta cuenta de Instagram ya está conectada en otra organización de esta instalación." },
  "Falta cadastrar a credencial do Instagram no painel do administrador.": { es: "Falta registrar la credencial de Instagram en el panel del administrador." },
  "Não foi possível conectar o Instagram. Tente de novo.": { es: "No se pudo conectar Instagram. Inténtalo de nuevo." },
  "Origem padrão salva.": { es: "Origen predeterminado guardado." },
  "Não foi possível salvar a origem padrão.": { es: "No se pudo guardar el origen predeterminado." },
  "Para usar a Origem padrão, crie no funil padrão um campo do tipo lista.": { es: "Para usar el Origen predeterminado, crea en el embudo predeterminado un campo de tipo lista." },
  "Origem padrão": { es: "Origen predeterminado" },
  "Todo contato novo que chegar por esta conta nasce com este valor.": { es: "Todo contacto nuevo que llegue por esta cuenta nace con este valor." },
  "Não foi possível desconectar a conta.": { es: "No se pudo desconectar la cuenta." },
  "As mensagens do Direct das contas conectadas entram no Inbox e viram lead no funil.": { es: "Los mensajes del Direct de las cuentas conectadas entran al Inbox y se vuelven lead en el embudo." },
  "Não foi possível carregar as contas do Instagram.": { es: "No se pudieron cargar las cuentas de Instagram." },
  "Conta do Instagram": { es: "Cuenta de Instagram" },
  "Recebendo mensagens": { es: "Recibiendo mensajes" },
  "Precisa reconectar": { es: "Necesita reconectar" },
  "Chave válida até": { es: "Clave válida hasta" },
  "Conectar Instagram": { es: "Conectar Instagram" },
  "Falta a credencial do Instagram nesta instalação.": { es: "Falta la credencial de Instagram en esta instalación." },
  "Copie o Instagram App ID e o Instagram App Secret.": { es: "Copia el Instagram App ID y el Instagram App Secret." },
  "Quem administra a instalação cola os dois na tela Meta do painel do administrador.": { es: "Quien administra la instalación pega los dos en la pantalla Meta del panel del administrador." },
  ...
  "Papel": { es: "Rol" },
  "Somente sua agenda e pacientes vinculados.": { es: "Solo su agenda y pacientes vinculados." },
  "Serviço do catálogo": { es: "Servicio del catálogo" },
  "Sala necessária": { es: "Sala necesaria" },
  "Chave de simultaneidade": { es: "Clave de simultaneidad" },
  "Sem vínculo": { es: "Sin vínculo" },
  "sem duração": { es: "sin duración" },
  "Nenhuma": { es: "Ninguna" },
  "Aplicação": { es: "Aplicación" },
  "Ex.: iv ou im": { es: "Ej.: iv o im" },
  "Unidade": { es: "Unidad" },
  "Teleconsulta ou sem unidade": { es: "Teleconsulta o sin unidad" },
  "Unidades e salas": { es: "Unidades y salas" },
  "A agenda escolhe automaticamente uma sala ativa e compatível.": { es: "La agenda elige automáticamente una sala activa y compatible." },
  "Nenhuma sala cadastrada.": { es: "No hay salas registradas." },
  "Unidade criada.": { es: "Unidad creada." },
  "Nome da unidade": { es: "Nombre de la unidad" },
  "Sala criada.": { es: "Sala creada." },
