...
| [`specs/20`](specs/20-spec-supervisao-de-agente.md) | **Supervisão de agente** — revisão pós-execução por outro agente (EXE/RECOM/BLOQ, idempotente, sem canal) e bloqueios obrigatórios do follow-up antes do envio. Migration 0263 |
