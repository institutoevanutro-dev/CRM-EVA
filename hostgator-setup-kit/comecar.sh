...
# Uso:
#   bash comecar.sh
#   curl -fsSL https://raw.githubusercontent.com/institutoevanutro-dev/CRM-EVA/main/hostgator-setup-kit/comecar.sh | bash
#
set -euo pipefail

REPO_URL="${REPO_URL:-https://github.com/institutoevanutro-dev/CRM-EVA.git}"
